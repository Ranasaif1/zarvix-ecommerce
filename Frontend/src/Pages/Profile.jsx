...
function Profile() {
    ...
    useEffect(() => {
        ...
        axios.get(`https://backend-phi-three-82.vercel.app/api/users/${user.id}/profile`)
            .then(response => {
    ...
    const handleSaveProfile = async (e) => {
        ...
        try {
            await axios.post(`https://backend-phi-three-82.vercel.app/api/users/${user.id}/profile`, profileData);
