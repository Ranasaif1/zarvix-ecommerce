...
function Notifications() {
    ...
    const fetchNotifications = useCallback(() => {
        setIsLoading(true);
        axios.get(`https://backend-phi-three-82.vercel.app/api/users/${user.id}/notifications`)
            .then(response => {
    ...
    const markAsRead = (id) => {
        ...
        axios.put(`https://backend-phi-three-82.vercel.app/api/notifications/${id}/read`)
    ...
    const markAllAsRead = () => {
        ...
        notifications.forEach(n => {
            if (!n.is_read) {
                axios.put(`https://backend-phi-three-82.vercel.app/api/notifications/${n.id}/read`)
                    .catch(error => console.error("Error marking read:", error));
            }
        });
    };
    ...
    const deleteNotification = (id) => {
        ...
        axios.delete(`https://backend-phi-three-82.vercel.app/api/notifications/${id}`)
